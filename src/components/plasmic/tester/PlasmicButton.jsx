...
import sty from "./PlasmicButton.module.css"; // plasmic-import: vN1tfmiUHUX/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: r3vL9Owr5dt/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: mmUGbRzP1au/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__tyOl8)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__xhsYs)}
                role={"img"}
              />
            ),
