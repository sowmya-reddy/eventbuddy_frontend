...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: 3VlgngjEZhC/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: oduMPN9aO05/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: r3vL9Owr5dt/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__njDtP)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__pvHlm)}
                role={"img"}
              />
            ),
